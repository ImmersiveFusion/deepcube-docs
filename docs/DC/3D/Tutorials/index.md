...
These walkthroughs show DeepCube in action - step by step through real-world troubleshooting and exploration workflows. Each scenario describes exactly what you do and what you see at every stage.

## Available Scenarios

| Scenario | Difficulty | Time | Description |
|----------|-----------|------|-------------|
| [Your First DeepCube Session](first-session.md) | :material-star: Beginner | 10 min | Get oriented in the 3D environment, learn basic controls, and meet Tessa |
...
- DeepCube [installed](../Guides/Installation/index.md) and running
...
!!! tip "ProTip"
    Context-aware guidance that appears in DeepCube itself.
